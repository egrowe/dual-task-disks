function runExp1_training_disks
...
blocks = [Shuffle([1,3,0]),5];

%Block definitions: 
% 0 = peripheral MvNM task: ALL-disk version
% 1 = central single-task
% 2 = peripheral SINGLE task: two-disk version (only red/green and green/red verticle split disks)
% 3 = peripheral SINGLE task: ALL-disk version (8 rotations of the red/green disk)
...
Exp_Parameters1_training_disks;
...
if cond == 2 || cond == 3 || cond == 4 || cond == 5
    ...
    %  thisTrialIs = (TR(tr).periphTypeRight == TR(tr).periphTypeLeft)
...
if cond == 0
    ...
    instr0 = 'Please focus on the CENTRE of the screen and rate whether the red/green or green/red disks presented to you in the PERIPHERY are a MATCH or NO MATCH.';
    
    DrawFormattedText(Cfg.windowPtr, 'Peripheral Task: Match vs No Match', 'center', 400, [255 255 255], 80, [], [], 2);
    DrawFormattedText(Cfg.windowPtr, instr0, 'center', 500, [255 255 255], 80, [], [], 2);
